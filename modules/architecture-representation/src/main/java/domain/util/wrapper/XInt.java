...
package domain.util.wrapper;

import domain.core.Solution;
import domain.core.SolutionType;
import domain.encodings.solutionType.ArrayIntSolutionType;
import domain.encodings.solutionType.IntSolutionType;
import domain.encodings.variable.ArrayInt;
...
public class XInt {
    ...
    public int getValue(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class) {
            ...
            Configuration.logger_.severe("domain.util.wrapper.XInt.getValue, solution type " +
                    type_ + "+ invalid");
        }
        return 0;
    } // Get value
    ...
    public void setValue(int index, int value) throws JMException {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("domain.util.wrapper.XInt.setValue, solution type " +
                    type_ + "+ invalid");
    } // setValue
    ...
    public int getLowerBound(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("domain.util.wrapper.Xreal.getLowerBound, solution type " +
                    type_ + "+ invalid");
        }
        return 0;
    } // getLowerBound
    ...
    public int getUpperBound(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("domain.util.wrapper.Xreal.getUpperBound, solution type " +
                    type_ + "+ invalid");
    ...
    public int getNumberOfDecisionVariables() {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("domain.util.wrapper.XInt.size, solution type " +
                    type_ + "+ invalid");
        return 0;
    } // size
} // XInt