...
public class Main {
     ...
     *                                - jmetal4.experiments.Main algorithmName
     *                                - jmetal4.experiments.Main algorithmName problemName
     *                                - jmetal4.experiments.Main algorithmName problemName paretoFrontFile
    ...
    public static void main(String[] args) throws
        ...
        if (args.length == 0) { //
            ...
            System.err.println("a) jmetal4.experiments.Main algorithmName ");
            System.err.println("b) jmetal4.experiments.Main algorithmName problemName");
            System.err.println("c) jmetal4.experiments.Main algorithmName problemName paretoFrontFile");
            System.exit(-1);
        } // if
