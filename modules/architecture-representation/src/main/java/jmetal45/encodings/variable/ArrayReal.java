...
package jmetal45.encodings.variable;

import jmetal45.core.Problem;
import jmetal45.core.Variable;
import jmetal45.util.Configuration;
...
public class ArrayReal extends Variable {
    ...
    public double getValue(int index) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("jmetal4.base.variable.ArrayReal.getValue: index value (" + index + ") invalid");
            throw new JMException("jmetal4.base.variable.ArrayReal: index value (" + index + ") invalid");
        } // if
    } // getValue
    ...
    public void setValue(int index, double value) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("jmetal4.base.variable.ArrayReal.setValue: index value (" + index + ") invalid");
            throw new JMException("jmetal4.base.variable.ArrayReal: index value (" + index + ") invalid");
        } // else
    } // setValue
    ...
    public double getLowerBound(int index) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("jmetal4.base.variable.ArrayReal.getLowerBound: index value (" + index + ") invalid");
            throw new JMException("jmetal4.base.variable.getLowerBound: index value (" + index + ") invalid");
        } // else
    } // getLowerBound
    ...
    public double getUpperBound(int index) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("jmetal4.base.variable.ArrayReal.getUpperBound: index value (" + index + ") invalid");
            throw new JMException("jmetal4.base.variable.getUpperBound: index value (" + index + ") invalid");
        } // else
    } // getLowerBound
