 ...
 * "java jmetal4.qualityIndicator.Spread <solutionFrontFile> <trueFrontFile>".
...
public class Spread {
    ...
    static jmetal45.qualityIndicator.util.MetricsUtil utils_;//utils_ is used to access to
    ...
    public double spread(double[][] front,
        ...
        Arrays.sort(normalizedFront,
                new jmetal45.qualityIndicator.util.LexicoGraphicalComparator());
