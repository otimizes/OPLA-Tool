 ...
 * "java jmetal4.qualityIndicator.InvertedGenerationalDistance <solutionFrontFile> <trueFrontFile>
 * <numberOfObjectives>"
...
public class InvertedGenerationalDistance {
    ...
    jmetal45.qualityIndicator.util.MetricsUtil utils_;  //utils_ is used to access to the
    //distances
