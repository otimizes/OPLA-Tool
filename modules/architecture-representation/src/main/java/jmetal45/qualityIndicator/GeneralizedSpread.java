...
package jmetal45.qualityIndicator;
 ...
 * $ java jmetal4.qualityIndicator.GeneralizedSpread <solutionFrontFile> <trueFrontFile> <numberOfObjectives>
...
public class GeneralizedSpread {
    ...
    static jmetal45.qualityIndicator.util.MetricsUtil utils_;  // MetricsUtil provides some
    ...
    public GeneralizedSpread() {
        utils_ = new jmetal45.qualityIndicator.util.MetricsUtil();
    } // GeneralizedSpread
    ...
    public double generalizedSpread(double[][] paretoFront,
        ...
        for (int i = 0; i < numberOfObjectives; i++) {
            Arrays.sort(normalizedParetoFront, new jmetal45.qualityIndicator.util.ValueComparator(i));
        ...
        Arrays.sort(normalizedFront, new jmetal45.qualityIndicator.util.LexicoGraphicalComparator());
