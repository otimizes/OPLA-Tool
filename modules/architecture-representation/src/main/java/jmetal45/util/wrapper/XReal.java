...
package jmetal45.util.wrapper;

import jmetal45.core.Solution;
import jmetal45.core.SolutionType;
import jmetal45.encodings.solutionType.ArrayRealSolutionType;
import jmetal45.encodings.solutionType.BinaryRealSolutionType;
import jmetal45.encodings.solutionType.RealSolutionType;
import jmetal45.encodings.variable.ArrayReal;
...
public class XReal {
    ...
    public double getValue(int index) throws JMException {
        if ((type_.getClass() == RealSolutionType.class) ||
            ...
            Configuration.logger_.severe("jmetal4.util.wrapper.XReal.getValue, solution type " +
                    type_ + "+ invalid");
        }
        return 0.0;
    }
    ...
    public void setValue(int index, double value) throws JMException {
        if (type_.getClass() == RealSolutionType.class)
            ...
            Configuration.logger_.severe("jmetal4.util.wrapper.XReal.setValue, solution type " +
                    type_ + "+ invalid");
    } // setValue
    ...
    public double getLowerBound(int index) throws JMException {
        if ((type_.getClass() == RealSolutionType.class) ||
            ...
            Configuration.logger_.severe("jmetal4.util.wrapper.XReal.getLowerBound, solution type " +
                    type_ + "+ invalid");
    ...
    public double getUpperBound(int index) throws JMException {
        if ((type_.getClass() == RealSolutionType.class) ||
            ...
            Configuration.logger_.severe("jmetal4.util.wrapper.XReal.getUpperBound, solution type " +
                    type_ + "+ invalid");
    ...
    public int getNumberOfDecisionVariables() {
        if ((type_.getClass() == RealSolutionType.class) ||
            ...
            Configuration.logger_.severe("jmetal4.util.wrapper.XReal.size, solution type " +
                    type_ + "+ invalid");
        return 0;
