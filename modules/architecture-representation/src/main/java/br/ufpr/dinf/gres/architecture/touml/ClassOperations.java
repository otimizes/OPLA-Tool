...
public class ClassOperations extends XmiHelper {
     ...
     * @return
     */
    public ClassOperations withMethods(final Set<br.ufpr.dinf.gres.architecture.touml.Method> methods) {
     ...
     * @return
     */
    public ClassOperations withMethod(final br.ufpr.dinf.gres.architecture.touml.Method method) {
        createMethod(method);
        return this;
    }

    private void createMethod(final br.ufpr.dinf.gres.architecture.touml.Method method) {
        br.ufpr.dinf.gres.architecture.touml.Document.executeTransformation(documentManager, new Transformation() {
            public void useTransformation() {
