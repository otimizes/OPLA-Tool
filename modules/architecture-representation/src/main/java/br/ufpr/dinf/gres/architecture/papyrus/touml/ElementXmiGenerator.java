...
public class ElementXmiGenerator extends XmiHelper {
    ...
    public Node generateClass(final br.ufpr.dinf.gres.architecture.representation.Element clazz, final String idPackage) {
    ...
    public void generateAttribute(br.ufpr.dinf.gres.architecture.papyrus.touml.Attribute attribute, String idClass) {
        if (idClass != null) {
    ...
    private String writeAttributeIntoUmlFile(br.ufpr.dinf.gres.architecture.papyrus.touml.Attribute attribute) {
