...
public class ArchitectureBuilder {
    ...
    /**
     * Cria a br.ufpr.dinf.gres.arquitetura. Primeiramente é carregado o model (arquivo .uml),
     ...
     * <br/>
     *
     * @param xmiFilePath - arquivo da br.ufpr.dinf.gres.arquitetura (.uml)
    ...
    public Architecture create(String xmiFilePath) throws Exception {
        try {
            ...
            for (br.ufpr.dinf.gres.architecture.representation.Package p : loadPackages())
