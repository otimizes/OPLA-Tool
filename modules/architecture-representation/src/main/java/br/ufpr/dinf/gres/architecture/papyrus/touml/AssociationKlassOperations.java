...
public class AssociationKlassOperations {
    ...
    private Set<br.ufpr.dinf.gres.architecture.papyrus.touml.Attribute> attrs;
    private Set<br.ufpr.dinf.gres.architecture.papyrus.touml.Method> methods;
    ...
    private static Set<br.ufpr.dinf.gres.architecture.papyrus.touml.Method> createMethods(AssociationClassRelationship klass) {
        Set<br.ufpr.dinf.gres.architecture.papyrus.touml.Method> methods = new HashSet<br.ufpr.dinf.gres.architecture.papyrus.touml.Method>();
        ...
        for (br.ufpr.dinf.gres.architecture.representation.Method method : methodsClass) {
            ...
            if (method.isAbstract()) {
                br.ufpr.dinf.gres.architecture.papyrus.touml.Method m = br.ufpr.dinf.gres.architecture.papyrus.touml.Method.create()
                        .withId(method.getId())
    ...
    private Set<br.ufpr.dinf.gres.architecture.papyrus.touml.Attribute> buildAttributes(AssociationClassRelationship asr) {
        Set<br.ufpr.dinf.gres.architecture.papyrus.touml.Attribute> attrs = new HashSet<br.ufpr.dinf.gres.architecture.papyrus.touml.Attribute>();
        for (Attribute attribute : asr.getAssociationClass().getAllAttributes()) {
            br.ufpr.dinf.gres.architecture.papyrus.touml.Attribute attr = br.ufpr.dinf.gres.architecture.papyrus.touml.Attribute.create()
    ...
    public void build() {
        ...
        for (final br.ufpr.dinf.gres.architecture.papyrus.touml.Attribute attribute : this.attrs) {
            br.ufpr.dinf.gres.architecture.papyrus.touml.Document.executeTransformation(documentManager, new Transformation() {
                public void useTransformation() {
        ...
        for (final br.ufpr.dinf.gres.architecture.papyrus.touml.Method method : this.methods) {
            br.ufpr.dinf.gres.architecture.papyrus.touml.Document.executeTransformation(documentManager, new Transformation() {
                public void useTransformation() {
        ...
        for (br.ufpr.dinf.gres.architecture.papyrus.touml.Attribute attribute : attrs) {
        ...
        for (br.ufpr.dinf.gres.architecture.papyrus.touml.Method method : methods) {
