...
public class StereotypeHelper {
    ...
    public static List<Comment> getCommentVariability(NamedElement element) {
         ...
         * é preciso recuperar todos os comentários que existem na br.ufpr.dinf.gres.arquitetura
     ...
     * Sendo assim os interesses que o usuário desejar usar na br.ufpr.dinf.gres.arquitetura devem estender do estereótipo <b>Concern</b>.<br/><br/>
     * <p>
