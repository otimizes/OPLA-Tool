...
/**
 * Classe responsável por verificar se modelo (br.ufpr.dinf.gres.arquitetura) é completa. Uma
 * br.ufpr.dinf.gres.arquitetura completa deve conter um arquivo .uml, .notation e .di
 *
