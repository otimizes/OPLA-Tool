...
import br.ufpr.dinf.gres.architecture.helpers.Uml2Helper;
import br.ufpr.dinf.gres.architecture.helpers.Uml2HelperFactory;
...
public class ClassOperations extends XmiHelper {
    ...
    public ClassOperations createClass(final br.ufpr.dinf.gres.architecture.representation.Element _klass) {
     ...
     * @return
     */
    public ClassOperations withMethods(final Set<br.ufpr.dinf.gres.architecture.papyrus.touml.Method> methods) {
     ...
     * @return
     */
    public ClassOperations withMethod(final br.ufpr.dinf.gres.architecture.papyrus.touml.Method method) {
        createMethod(method);
        return this;
    }

    private void createMethod(final br.ufpr.dinf.gres.architecture.papyrus.touml.Method method) {
        br.ufpr.dinf.gres.architecture.papyrus.touml.Document.executeTransformation(documentManager, new Transformation() {
            public void useTransformation() {
