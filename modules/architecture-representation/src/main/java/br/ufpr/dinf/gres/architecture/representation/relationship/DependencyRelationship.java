...
public class DependencyRelationship extends Relationship {
     ...
     * @throws br.ufpr.dinf.gres.architecture.exceptions.NotFoundException caso não exista pacote envolvido na dependencia.
     */
     ...
     * @throws br.ufpr.dinf.gres.architecture.exceptions.NotFoundException caso não exista interface envolvido na dependencia.
     */
