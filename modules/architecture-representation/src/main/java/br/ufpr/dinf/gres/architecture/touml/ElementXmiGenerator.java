...
public class ElementXmiGenerator extends XmiHelper {
    ...
    public void generateAttribute(br.ufpr.dinf.gres.architecture.touml.Attribute attribute, String idClass) {
        if (idClass != null) {
    ...
    private String writeAttributeIntoUmlFile(br.ufpr.dinf.gres.architecture.touml.Attribute attribute) {
