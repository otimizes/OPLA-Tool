...
public class Database {
    ...
    /**
     * Create a connection with jmetal4.database and returns a Statement to working
     * with.
     *
     * @return
     * @throws Exception
    ...
    public static Connection getConnection() throws Exception {
        ...
        if (StringUtils.EMPTY.equals(pathDatabase)) {
            LOGGER.info("Path to jmetal4.database should not be blank");
            throw new MissingConfigurationException("Path to jmetal4.database should not be blank");
        }
