...
public class GeneralizedSpread {
    ...
    static jmetal4.qualityIndicator.util.MetricsUtil utils_;  // MetricsUtil provides some
    ...
    public double generalizedSpread(double[][] paretoFront,
        ...
        for (int i = 0; i < numberOfObjectives; i++) {
            Arrays.sort(normalizedParetoFront, new jmetal4.qualityIndicator.util.ValueComparator(i));
        ...
        Arrays.sort(normalizedFront, new jmetal4.qualityIndicator.util.LexicoGraphicalComparator());
