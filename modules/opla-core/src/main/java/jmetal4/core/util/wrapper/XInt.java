...
package jmetal4.core.util.wrapper;

import jmetal4.core.core.Solution;
import jmetal4.core.core.SolutionType;
import jmetal4.core.encodings.solutionType.ArrayIntSolutionType;
import jmetal4.core.encodings.solutionType.IntSolutionType;
import jmetal4.core.encodings.variable.ArrayInt;
...
public class XInt {
    ...
    public int getValue(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class) {
            ...
            Configuration.logger_.severe("jmetal4.core.util.wrapper.XInt.getValue, solution type " +
                    type_ + "+ invalid");
        }
        return 0;
    } // Get value
    ...
    public void setValue(int index, int value) throws JMException {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("jmetal4.core.util.wrapper.XInt.setValue, solution type " +
                    type_ + "+ invalid");
    } // setValue
    ...
    public int getLowerBound(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("jmetal4.core.util.wrapper.Xreal.getLowerBound, solution type " +
                    type_ + "+ invalid");
        }
        return 0;
    } // getLowerBound
    ...
    public int getUpperBound(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("jmetal4.core.util.wrapper.Xreal.getUpperBound, solution type " +
                    type_ + "+ invalid");
    ...
    public int getNumberOfDecisionVariables() {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("jmetal4.core.util.wrapper.XInt.size, solution type " +
                    type_ + "+ invalid");
        return 0;
    } // size
} // XInt