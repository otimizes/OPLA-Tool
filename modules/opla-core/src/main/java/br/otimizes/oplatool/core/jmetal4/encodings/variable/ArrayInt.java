...
public class ArrayInt extends Variable {
    ...
    public int getValue(int index) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayInt.getValue: index value (" + index + ") invalid");
            throw new JMException("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayInt: index value (" + index + ") invalid");
        } // if
    } // getValue
    ...
    public void setValue(int index, int value) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayInt.setValue: index value (" + index + ") invalid");
            throw new JMException("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayInt: index value (" + index + ") invalid");
        } // else
    } // setValue
    ...
    public double getLowerBound(int index) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayInt.getLowerBound: index value (" + index + ") invalid");
    ...
    public double getUpperBound(int index) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayInt.getUpperBound: index value (" + index + ") invalid");
