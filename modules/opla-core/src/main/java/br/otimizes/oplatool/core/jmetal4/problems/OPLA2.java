...
public class OPLA2 extends AbstractOPLAProblem {

    private static final Logger LOGGER = Logger.getLogger(OPLA2.class);
    ...
    public OPLA2(String xmiFilePath) throws Exception {
...
//                .forName(Architecture.ARCHITECTURE_TYPE);
    ...
    public OPLA2(String xmiFilePath, ExperimentCommonConfigs oplaConfig) throws Exception {
...
//        variableType_[0] = java.lang.Class.forName(Architecture.ARCHITECTURE_TYPE);
    ...
    @Override
    public OPLASolution2 createSolution() {
        return null;
    }

    @Override
    public void evaluate(OPLASolution2 solution) {
        ...
        for (String selectedMetric : selectedMetrics) {
            ...
            fitnesses.add(new Fitness(metric.evaluate(solution.getVariable(0))));
        }
