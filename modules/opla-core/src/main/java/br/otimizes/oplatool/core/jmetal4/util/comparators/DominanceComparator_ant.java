 ...
 */
public class DominanceComparator_ant implements Comparator {
 ...
 //           System.out.println("  DominanciaAnterior: iguais ");
            return 0; //No one dominate the other
        }
        if (dominate1 == 1) {
 //           System.out.println("  DominanciaAnterior: obj1 -1");
            return -1; // solution1 dominate
        }
 //       System.out.println("  DominanciaAnterior: obj2 1");
