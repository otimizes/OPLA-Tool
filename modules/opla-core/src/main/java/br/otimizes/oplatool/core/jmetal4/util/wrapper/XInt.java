...
import br.otimizes.oplatool.core.jmetal4.encodings.solutionType.ArrayIntSolutionType;
import br.otimizes.oplatool.core.jmetal4.encodings.solutionType.IntSolutionType;
import br.otimizes.oplatool.core.jmetal4.encodings.variable.ArrayInt;
...
public class XInt {
    ...
    public int getValue(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class) {
            ...
            Configuration.logger_.severe("br.otimizes.oplatool.core.jmetal4.core.util.wrapper.XInt.getValue, solution type " +
                    type_ + "+ invalid");
        }
        return 0;
    } // Get value
    ...
    public void setValue(int index, int value) throws JMException {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("br.otimizes.oplatool.core.jmetal4.core.util.wrapper.XInt.setValue, solution type " +
                    type_ + "+ invalid");
    } // setValue
    ...
    public int getNumberOfDecisionVariables() {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("br.otimizes.oplatool.core.jmetal4.core.util.wrapper.XInt.size, solution type " +
                    type_ + "+ invalid");
        return 0;
    } // size
} // XInt