...
public class ArrayReal extends Variable {
    ...
    public double getValue(int index) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayReal.getValue: index value (" + index + ") invalid");
            throw new JMException("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayReal: index value (" + index + ") invalid");
        } // if
    } // getValue
    ...
    public void setValue(int index, double value) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayReal.setValue: index value (" + index + ") invalid");
            throw new JMException("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayReal: index value (" + index + ") invalid");
        } // else
    } // setValue
    ...
    public double getLowerBound(int index) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayReal.getLowerBound: index value (" + index + ") invalid");
            throw new JMException("br.otimizes.oplatool.core.jmetal4.base.variable.getLowerBound: index value (" + index + ") invalid");
        } // else
    } // getLowerBound
    ...
    public double getUpperBound(int index) throws JMException {
        if ((index >= 0) && (index < size_))
            ...
            Configuration.logger_.severe("br.otimizes.oplatool.core.jmetal4.base.variable.ArrayReal.getUpperBound: index value (" + index + ") invalid");
            throw new JMException("br.otimizes.oplatool.core.jmetal4.base.variable.getUpperBound: index value (" + index + ") invalid");
        } // else
    } // getLowerBound
