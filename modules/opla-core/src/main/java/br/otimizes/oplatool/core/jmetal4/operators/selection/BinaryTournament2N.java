 ...
 */
public class BinaryTournament2N extends Selection {

    private static final Logger LOGGER = Logger.getLogger(BinaryTournament2N.class);
     ...
     */
    public BinaryTournament2N(Map<String, Object> parameters) {
        super(parameters);
