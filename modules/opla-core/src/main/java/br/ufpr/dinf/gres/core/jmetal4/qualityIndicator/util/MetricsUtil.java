...
package br.ufpr.dinf.gres.core.jmetal4.qualityIndicator.util;
...
public class MetricsUtil {
    ...
    public SolutionSet readNonDominatedSolutionSet(String path) {
      ...
      /* Open the file */
            ...
            System.out.println("br.ufpr.dinf.gres.core.jmetal4.qualityIndicator.util.readNonDominatedSolutionSet: " + path);
            e.printStackTrace();
        }
        return null;
