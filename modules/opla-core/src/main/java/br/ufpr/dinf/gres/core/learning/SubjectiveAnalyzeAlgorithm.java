...
public class SubjectiveAnalyzeAlgorithm {
    ...
    private void logMachineLearningModel() {
        ...
        try {
            fileWriter = new FileWriter(OPLAConfigThreadScopeReader.getDirectoryToExportModels() + System.getProperty("file.separator") + "LogMachineLearningModel_" + currentEvaluation + ".arff");
    ...
    private void logMachineLearningModelEvaluation(StringBuilder stringBuilder) {
        FileWriter fileWriter = null;
        try {
            fileWriter = new FileWriter(OPLAConfigThreadScopeReader.getDirectoryToExportModels() + System.getProperty("file.separator") + "LogMachineLearningModelEvaluation_" + currentEvaluation + ".arff");
        } catch (IOException ex) {
            ex.printStackTrace();
        }
