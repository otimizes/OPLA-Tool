...
/**
 * Class for generating br.ufpr.dinf.gres.core.jmetal4.results in form of boxplots
 */
public class RBoxplot {
    /**
     * This method produces R scripts for generating eps files containing boxplots
     * of the br.ufpr.dinf.gres.core.jmetal4.results previosly obtained. The boxplots will be arranged in a grid
