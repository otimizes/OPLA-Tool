...
public class SettingsFactory {
    ...
    public Settings getSettingsObject(String algorithmName, Object[] params)
            throws JMException {
        String base = "br.ufpr.dinf.gres.core.jmetal4.experiments.settings." + algorithmName + "_Settings";
        try {
            ...
            Configuration.logger_.severe("SettingsFactory.getSettingsObject: " +
                    ...
                    "Please, check the algorithm name in br.ufpr.dinf.gres.core.jmetal4/metaheuristics");
