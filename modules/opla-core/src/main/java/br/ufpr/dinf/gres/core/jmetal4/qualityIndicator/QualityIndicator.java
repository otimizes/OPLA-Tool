...
public class QualityIndicator {
    ...
    Problem problem_;
    br.ufpr.dinf.gres.core.jmetal4.qualityIndicator.util.MetricsUtil utilities_;
    ...
    public QualityIndicator(Problem problem, String paretoFrontFile) {
        problem_ = problem;
        utilities_ = new br.ufpr.dinf.gres.core.jmetal4.qualityIndicator.util.MetricsUtil();
