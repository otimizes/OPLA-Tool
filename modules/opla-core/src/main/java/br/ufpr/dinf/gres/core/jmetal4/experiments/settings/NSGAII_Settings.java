...
public class NSGAII_Settings extends Settings {
     ...
     * @throws JMException
     */
    public br.ufpr.dinf.gres.core.jmetal4.core.Algorithm configure() throws JMException {
        Algorithm algorithm;
        Selection selection;
        Crossover crossover;
        Mutation mutation;
        ...
        br.ufpr.dinf.gres.core.jmetal4.qualityIndicator.QualityIndicator indicators;
