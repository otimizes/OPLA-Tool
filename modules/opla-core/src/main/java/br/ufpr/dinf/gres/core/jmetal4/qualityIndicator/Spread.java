 ...
 * "java br.ufpr.dinf.gres.core.jmetal4.qualityIndicator.Spread <solutionFrontFile> <trueFrontFile>".
...
public class Spread {
    ...
    public double spread(double[][] front,
        ...
        Arrays.sort(normalizedFront,
                new br.ufpr.dinf.gres.core.jmetal4.qualityIndicator.util.LexicoGraphicalComparator());
