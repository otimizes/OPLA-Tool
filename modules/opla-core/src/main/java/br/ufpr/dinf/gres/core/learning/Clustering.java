...
public class Clustering implements Serializable {
    ...
    /**
     * Method not completed, because in the current version of Weka, the OPTICS does not present br.ufpr.dinf.gres.core.jmetal4.results
     *
     * @return Nothing
     * @throws Exception Default Exception
     */
...
//        LOGGER.info(getClusterEvaluation().clusterResultsToString());
    ...
    /**
     * Cluster Evaluation Object for analysis of br.ufpr.dinf.gres.core.jmetal4.results
     *
