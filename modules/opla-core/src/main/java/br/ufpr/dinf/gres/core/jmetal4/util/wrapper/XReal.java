...
public class XReal {
    ...
    public double getValue(int index) throws JMException {
        if ((type_.getClass() == RealSolutionType.class) ||
            ...
            Configuration.logger_.severe("br.ufpr.dinf.gres.core.jmetal4.core.util.wrapper.XReal.getValue, solution type " +
                    type_ + "+ invalid");
        }
        return 0.0;
    }
    ...
    public void setValue(int index, double value) throws JMException {
        if (type_.getClass() == RealSolutionType.class)
            ...
            Configuration.logger_.severe("br.ufpr.dinf.gres.core.jmetal4.core.util.wrapper.XReal.setValue, solution type " +
                    type_ + "+ invalid");
    } // setValue
    ...
    public int getNumberOfDecisionVariables() {
        if ((type_.getClass() == RealSolutionType.class) ||
            ...
            Configuration.logger_.severe("br.ufpr.dinf.gres.core.jmetal4.core.util.wrapper.XReal.size, solution type " +
                    type_ + "+ invalid");
        return 0;
