...
package br.ufpr.dinf.gres.core.jmetal4.util.wrapper;

import br.ufpr.dinf.gres.core.jmetal4.core.Solution;
import br.ufpr.dinf.gres.core.jmetal4.core.SolutionType;
import br.ufpr.dinf.gres.core.jmetal4.encodings.solutionType.ArrayIntSolutionType;
import br.ufpr.dinf.gres.core.jmetal4.encodings.solutionType.IntSolutionType;
import br.ufpr.dinf.gres.core.jmetal4.encodings.variable.ArrayInt;
...
public class XInt {
    ...
    public int getValue(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class) {
            ...
            Configuration.logger_.severe("br.ufpr.dinf.gres.core.jmetal4.core.util.wrapper.XInt.getValue, solution type " +
                    type_ + "+ invalid");
        }
        return 0;
    } // Get value
    ...
    public void setValue(int index, int value) throws JMException {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("br.ufpr.dinf.gres.core.jmetal4.core.util.wrapper.XInt.setValue, solution type " +
                    type_ + "+ invalid");
    } // setValue
    ...
    public int getLowerBound(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("br.ufpr.dinf.gres.core.jmetal4.core.util.wrapper.Xreal.getLowerBound, solution type " +
                    type_ + "+ invalid");
        }
        return 0;
    } // getLowerBound
    ...
    public int getUpperBound(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("br.ufpr.dinf.gres.core.jmetal4.core.util.wrapper.Xreal.getUpperBound, solution type " +
                    type_ + "+ invalid");
    ...
    public int getNumberOfDecisionVariables() {
        if (type_.getClass() == IntSolutionType.class)
            ...
            Configuration.logger_.severe("br.ufpr.dinf.gres.core.jmetal4.core.util.wrapper.XInt.size, solution type " +
                    type_ + "+ invalid");
        return 0;
    } // size
} // XInt