...
import br.ufpr.dinf.gres.core.jmetal4.metaheuristics.memetic.Bestof2;
...
public class BestOf2OPLABase {
    ...
    public void execute(NSGAIIConfigs configs) throws Exception {
        ...
        for (String pla : plas) {
            ...
            Experiment experiement = mp.saveExperiment(plaName, "Bestof2", configs.getDescription(), OPLAThreadScope.hash.get());
