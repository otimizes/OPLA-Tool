...
import jmetal4core.util.NonDominatedSolutionList;
import jmetal4core.core.SolutionSet;
import jmetal4core.qualityIndicator.util.MetricsUtil;
...
public class CalculaEd {
    ...
    private jmetal4core.qualityIndicator.util.MetricsUtil mu;
    ...
    public HashMap<String, Double> calcula(String experimentId, int numberObjectives) throws Exception {
        jmetal4core.core.SolutionSet ss = queryNonDominatedSolutinsFromExperiment(experimentId);
     ...
     * @throws Exception
     */
    public jmetal4core.core.SolutionSet queryNonDominatedSolutinsFromExperiment(String experimentID) throws Exception {
        try {
