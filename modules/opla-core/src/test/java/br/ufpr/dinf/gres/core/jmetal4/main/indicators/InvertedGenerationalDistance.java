...
public class InvertedGenerationalDistance {
    ...
    public static void main(String args[]) {
        ...
        br.ufpr.dinf.gres.core.jmetal4.qualityIndicator.InvertedGenerationalDistance qualityIndicator = new br.ufpr.dinf.gres.core.jmetal4.qualityIndicator.InvertedGenerationalDistance();
