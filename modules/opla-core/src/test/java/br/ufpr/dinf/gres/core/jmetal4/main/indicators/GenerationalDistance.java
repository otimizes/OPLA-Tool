...
public class GenerationalDistance {
    ...
    public static void main(String[] args) {
        ...
        br.ufpr.dinf.gres.core.jmetal4.qualityIndicator.GenerationalDistance qualityIndicator = new br.ufpr.dinf.gres.core.jmetal4.qualityIndicator.GenerationalDistance();
