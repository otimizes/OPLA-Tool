...
public class Spread {
    ...
    public static void main(String[] args) {
        ...
        br.otimizes.oplatool.core.jmetal4.qualityIndicator.Spread qualityIndicator = new br.otimizes.oplatool.core.jmetal4.qualityIndicator.Spread();

        // STEP 2. Read the fronts from the files
        double[][] solutionFront = br.otimizes.oplatool.core.jmetal4.qualityIndicator.Spread.utils_.readFront(args[0]);
        double[][] trueFront = br.otimizes.oplatool.core.jmetal4.qualityIndicator.Spread.utils_.readFront(args[1]);
