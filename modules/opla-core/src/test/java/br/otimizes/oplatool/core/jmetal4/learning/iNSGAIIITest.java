...
//        NSGAIIIConfigs configs = getNsgaiiConfigs();
//        NSGAIIIAlgorithmAdapter algorithm;
...
//
//
//        SubjectiveAnalyzeAlgorithm subjectiveAnalyzeAlgorithm = algorithm.getHandler().getSubjectiveAnalyzeAlgorithm();
...
//    }
//
//    private NSGAIIIAlgorithmAdapter getAlgorithm(String xmiFilePath, NSGAIIIConfigs configs) throws Exception {
//        OPLA opla = new OPLA(xmiFilePath, configs);
//
//        NSGAIIIAlgorithmAdapter algorithm = new NSGAIIIAlgorithmAdapter(opla);
...
//    }
//
//    private static NSGAIIIConfigs getNsgaiiConfigs() {
