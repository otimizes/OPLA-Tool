...
@Component
public class BestOf2Gateway implements IGateway<NSGAIIConfigs> {

    public BestOf2Gateway(Persistence persistence, EdCalculation edCalculation) {
    ...
    private static final Logger LOGGER = Logger.getLogger(BestOf2Gateway.class);
