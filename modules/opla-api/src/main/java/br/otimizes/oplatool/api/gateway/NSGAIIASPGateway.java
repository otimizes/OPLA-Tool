...
@Component
public class NSGAIIASPGateway implements IGateway<NSGAIIConfigs> {

    public NSGAIIASPGateway(Persistence persistence, EdCalculation edCalculation) {
    ...
    private static final Logger LOGGER = Logger.getLogger(NSGAIIASPGateway.class);
