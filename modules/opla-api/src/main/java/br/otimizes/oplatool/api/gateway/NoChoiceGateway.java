...
@Component
public class NoChoiceGateway implements IGateway<NSGAIIConfigs> {

    public NoChoiceGateway(Persistence persistence, EdCalculation edCalculation) {
    ...
    private static final Logger LOGGER = Logger.getLogger(NoChoiceGateway.class);
    ...
    public void execute(NSGAIIConfigs configs) throws Exception {
        ...
        for (String xmiFilePath : plas) {
            ...
            Experiment experiment = persistence.save(plaName, "NoChoice", configs.getDescription(),
    ...
    private Algorithm getAlgorithm(OPLA problem, NSGAIIConfigs configs, Experiment experiment) throws JMException {
        ...
        Algorithm algorithm = new NoChoice(problem);
