...
public class FeatureDrivenMetricResource extends BaseResource<FeatureDrivenMetric> {
    public FeatureDrivenMetricResource(BaseService<FeatureDrivenMetric> service) {
        super(service);
    }
}