...
@Entity
@Table(name = "AvMetrics")
public class AvMetric implements GenericMetric {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, av, execution, experiement, isAll, idSolution);
    }

    @Override
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SIMPLE_STYLE).append("id", id)
                .append("av", av).append("executionId", execution)
