...
import br.ufpr.dinf.gres.patterns.models.ps.impl.PSBridge;
import br.ufpr.dinf.gres.patterns.models.ps.impl.PSPLABridge;
import br.ufpr.dinf.gres.patterns.models.ps.impl.PSStrategy;
import br.ufpr.dinf.gres.patterns.util.BridgeUtil;
    ...
    public boolean apply(Scope scope) {
        ...
        if (!pSs.isEmpty()) {
            ...
            if (!participants.isEmpty()) {
                ...
                br.ufpr.dinf.gres.architecture.representation.Class abstractClass = (br.ufpr.dinf.gres.architecture.representation.Class) abstractionClasses.get(0);
