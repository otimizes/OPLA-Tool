...
public class Utils {
    ...
    public static void createPathsOplaTool() throws Exception {
        try {
            ...
            if (!Files.exists(pathApplicationYaml)) {
                br.ufpr.dinf.gres.architecture.io.FileUtils.copy("config/application.yaml", pathApplicationYaml);
            }
    ...
    public static String generateFileName(String id) {
        String algorithmName = br.ufpr.dinf.gres.domain.db.Database.getAlgoritmUsedToExperimentId(id);
        String plaName = br.ufpr.dinf.gres.domain.db.Database.getPlaUsedToExperimentId(id);
