...
public class Database {
    ...
    public static Map<String, String> getObjectivesBySolutionId(String solutionId, String experimentId) {
        ...
        String ordenedObjectives[] = br.ufpr.dinf.gres.domain.db.Database.getOrdenedObjectives(experimentId).split(" ");

        try {
            try (Statement statement = br.ufpr.dinf.gres.core.jmetal4.database.Database.getConnection().createStatement()) {
    ...
    public static String getOrdenedObjectives(String experimentId) {
        ...
        try {
            statement = br.ufpr.dinf.gres.core.jmetal4.database.Database.getConnection().createStatement();
    ...
    public static Map<String, List<Double>> getAllObjectivesForDominatedSolutions(String... exeprimentIds)
        ...
        for (String exeprimentId : exeprimentIds) {
            ...
            String[] objectives = br.ufpr.dinf.gres.domain.db.Database.getOrdenedObjectives(exeprimentId).split(" ");

            statementExecutions = br.ufpr.dinf.gres.core.jmetal4.database.Database.getConnection().createStatement();
            statement = br.ufpr.dinf.gres.core.jmetal4.database.Database.getConnection().createStatement();
