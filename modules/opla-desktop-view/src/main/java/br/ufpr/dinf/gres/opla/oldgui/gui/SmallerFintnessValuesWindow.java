...
import br.ufpr.dinf.gres.opla.oldgui.indicators.Indicators;
import br.ufpr.dinf.gres.opla.oldgui.utils.GuiUtils;
import br.ufpr.dinf.gres.opla.db.BestSolutionBySelectedFitness;
...
public class SmallerFintnessValuesWindow extends javax.swing.JFrame {
    ...
    private void includeTableObjectives(String selectedSolutionId) {
        Map<String, String> result = br.ufpr.dinf.gres.opla.db.Database.getObjectivesBySolutionId(selectedSolutionId, selectedExperiment);
    ...
    public void enablePanelsObjectiveFunctions() {
        String metricsSelectedForCurrentExperiment[] = br.ufpr.dinf.gres.opla.db.Database.getOrdenedObjectives(this.selectedExperiment)
                .split(" ");
    ...
    private void selectSolutionForTables(List<JTable> tables, int x) {
        List<String> objs = Arrays.asList(br.ufpr.dinf.gres.opla.db.Database.getOrdenedObjectives(selectedExperiment).split(" "));
