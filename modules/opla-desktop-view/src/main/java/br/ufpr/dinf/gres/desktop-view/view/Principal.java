...
import br.ufpr.dinf.gres.domain.view.analysis.BoxPlot;
import br.ufpr.dinf.gres.domain.view.analysis.BoxPlotItem;
import br.ufpr.dinf.gres.domain.view.enumerators.Metric;
import br.ufpr.dinf.gres.domain.view.log.LogListener;
import br.ufpr.dinf.gres.domain.view.model.combomodel.*;
import br.ufpr.dinf.gres.domain.view.model.tablemodel.AbstractMetricTableModel;
import br.ufpr.dinf.gres.domain.view.model.tablemodel.ExecutionTableModel;
import br.ufpr.dinf.gres.domain.view.model.tablemodel.ExperimentTableModel;
import br.ufpr.dinf.gres.domain.view.model.tablemodel.MapObjectiveNameTableModel;
import br.ufpr.dinf.gres.domain.view.util.*;
...
import br.ufpr.dinf.gres.domain.oldgui.gui.HypervolumeWindow;
import br.ufpr.dinf.gres.domain.oldgui.gui.SmallerFintnessValuesWindow;
import br.ufpr.dinf.gres.domain.oldgui.gui.StartUp;
import br.ufpr.dinf.gres.domain.oldgui.indicators.HypervolumeData;
import br.ufpr.dinf.gres.domain.oldgui.indicators.HypervolumeGenerateObjsData;
...
import br.ufpr.dinf.gres.core.jmetal4.experiments.AlgorithmExperiment;
...
import br.ufpr.dinf.gres.core.jmetal4.util.RScriptOptionElement;
...
public class Principal extends AbstractPrincipalJFrame {
    ...
    public static void copyTemplates() throws URISyntaxException {
        URI uriTemplatesDir = ClassLoader.getSystemResource(br.ufpr.dinf.gres.architecture.util.Constants.BASE_RESOURCES + Constants.TEMPLATES_DIR).toURI();
    ...
    private void btBoxPlotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBoxPlotActionPerformed
        try {
            ...
            Map<String, List<Double>> content = br.ufpr.dinf.gres.domain.db.Database.getAllObjectivesForDominatedSolutions(ids);
