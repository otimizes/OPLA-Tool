package br.ufpr.dinf.gres.domain.oldgui.configuration;
...
public class VolatileConfs {
    ...
    private static List<String> objectiveFunctionsSelected = new ArrayList<>(); //checkboxs br.ufpr.dinf.gres.core.jmetal4.metrics
