package br.ufpr.dinf.gres.domain.view.analysis;
...
public class WBoxAndWhiskerRenderer extends BoxAndWhiskerRenderer {
    public WBoxAndWhiskerRenderer() {
            ...
            if (yMean != null) {
                ...
                if ((yyAverage > (dataArea.getMinY() - aRadius))
                    ...
                    Ellipse2D.Double avgEllipse = new Ellipse2D.Double(
                            xx + aRadius * 1.5, yyAverage - aRadius * 0.7, aRadius,
                            aRadius);
                    g2.fill(avgEllipse);
                    g2.draw(avgEllipse);
                }
