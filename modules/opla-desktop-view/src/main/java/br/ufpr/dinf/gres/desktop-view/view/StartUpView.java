...
import br.ufpr.dinf.gres.domain.view.util.AlertUtil;
import br.ufpr.dinf.gres.domain.view.util.UserHome;
import br.ufpr.dinf.gres.domain.view.util.Utils;
...
public class StartUpView extends javax.swing.JFrame {
    ...
    public StartUpView() {
        OPLAThreadScope.setConfig(br.ufpr.dinf.gres.architecture.config.ApplicationFile.getInstance().getApplicationYaml());
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        br.ufpr.dinf.gres.domain.config.ApplicationYamlConfig applicationYaml = ApplicationFile.getInstance().getApplicationYaml();
    ...
    private static void executeCommandLineAlgorithm() {
        ...
        try {
            ...
            br.ufpr.dinf.gres.domain.view.Principal.copyTemplates();
        } catch (IOException | URISyntaxException e) {
            e.printStackTrace();
        }
        br.ufpr.dinf.gres.domain.view.Principal.executeCommandLineAlgorithm(
                new AlgorithmExperiment(StartUpView.arguments.get("algorithm"),
                        ...
                        StartUpView.arguments.get("br/ufpr/dinf/gres/patterns"),
    ...
    private void carregarPrincipal() throws Exception {
        br.ufpr.dinf.gres.domain.view.Principal principal = new br.ufpr.dinf.gres.domain.view.Principal();
