...
public class Principal extends AbstractPrincipalJFrame {
    ...
    private void initComponents() {
        ...
        ckFeatureDrivenMutation.setSelected(false);
        ckFeatureDrivenMutation.addItemListener(e -> {
        ...
        ckMoveMethodMutation.addItemListener(e -> {
        ...
        ckAddClassMutation.addItemListener(e -> {
        ...
        ckMoveOperationMutation.addItemListener(e -> {
        ...
        ckAddManagerClassMutation.addItemListener(e -> {
        ...
        ckMoveAttributeMutation.addItemListener(e -> {
            if (ckMoveAttributeMutation.isSelected())
                MutationOperatorsSelected.getSelectedMutationOperators().add(FeatureMutationOperators.MOVE_ATTRIBUTE_MUTATION.getOperatorName());
            else
                MutationOperatorsSelected.getSelectedMutationOperators().remove(FeatureMutationOperators.MOVE_ATTRIBUTE_MUTATION.getOperatorName());
        });
        ...
        ckMediator.addActionListener(e -> {
        ...
        ckStrategy.addActionListener(e -> {
    ...
    private void btViewApplicationConfigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btViewApplicationConfigActionPerformedwe
        ApplicationYamlView applicationYamlView = new ApplicationYamlView(config);
        applicationYamlView.setVisible(true);
    }//GEN-LAST:event_btViewApplicationConfigActionPerformed
