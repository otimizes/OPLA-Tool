package br.ufpr.dinf.gres.opla.db;
...
public class BestSolutionBySelectedFitness {
    ...
    public static List<jmetal4.metrics.Metrics> calculateBestFeatureDriven(String experimentId) {
        return br.ufpr.dinf.gres.opla.db.Database.getAllFeatureDrivenMetricsForExperimentId(experimentId);
    }

    public static List<jmetal4.metrics.Metrics> calculateBestElegance(String experimentId) {
        return br.ufpr.dinf.gres.opla.db.Database.getAllEleganceMetricsForExperimentId(experimentId);

    }

    public static List<jmetal4.metrics.Metrics> calculateBestConventional(String experimentId) {
        return br.ufpr.dinf.gres.opla.db.Database.getAllConventionalMetricsForExperimentId(experimentId);

    }

    public static List<jmetal4.metrics.Metrics> calculateBestPlaExt(String experimentId) {
        return br.ufpr.dinf.gres.opla.db.Database.getAllPLAExtMetricsForExperimentId(experimentId);
    }

    //---addYni---

    public static List<jmetal4.metrics.Metrics> calculateBestWocsC(String experimentId) {
        return br.ufpr.dinf.gres.opla.db.Database.getAllWocsCMetricsForExperimentId(experimentId);
    }

    public static List<jmetal4.metrics.Metrics> calculateBestWocsI(String experimentId) {
        return br.ufpr.dinf.gres.opla.db.Database.getAllWocsIMetricsForExperimentId(experimentId);
    }

    public static List<jmetal4.metrics.Metrics> calculateBestCbcs(String experimentId) {
        return br.ufpr.dinf.gres.opla.db.Database.getAllCbcsMetricsForExperimentId(experimentId);
    }

    public static List<jmetal4.metrics.Metrics> calculateBestSvc(String experimentId) {
        return br.ufpr.dinf.gres.opla.db.Database.getAllSvcMetricsForExperimentId(experimentId);
    }

    public static List<jmetal4.metrics.Metrics> calculateBestSsc(String experimentId) {
        return br.ufpr.dinf.gres.opla.db.Database.getAllSscMetricsForExperimentId(experimentId);
    }

    public static List<jmetal4.metrics.Metrics> calculateBestAv(String experimentId) {
        return br.ufpr.dinf.gres.opla.db.Database.getAllAvMetricsForExperimentId(experimentId);
    }
    //---addYni---
    ...
    public static void buildTable(JTable tableMinorFitnessValues, List<jmetal4.metrics.Metrics> map) {
        ...
        for (int i = 0; i < map.size(); i++) {
            data[i] = new String[]{br.ufpr.dinf.gres.opla.db.Database.getNameSolutionById(map.get(i).getIdSolution()), String.valueOf(getValueFitness(map.get(i)))};
        }
